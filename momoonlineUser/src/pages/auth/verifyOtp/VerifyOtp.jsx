            ...
            {/* <h3>Hello</h3> */}
              ...
              <form className="p-12 md:p-24" onSubmit={handleSubmit} noValidate>
                <div className="flex flex-col items-center text-lg mb-6 md:mb-8">
                  ...
                  <input type="otp" id="otp" name='otp' className="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="OTP" onChange={(e) => setOtp(e.target.value) } />
                  <p className='text-red-500 text-sm italic'></p>
                </div>
                
                <button className="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full" >Verify</button>
              </form>
            </div>
          </div>
        </>
