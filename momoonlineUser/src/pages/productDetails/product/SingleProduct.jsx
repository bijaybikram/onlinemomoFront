...
const SingleProduct = ({id: productId}) => {
    ...
    const {product, productReviews} = selectedProduct
    // console.log(productReviews, "hello")
        ...
        <div className="container px-5 py-24 mx-auto">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <span className="flex items-center">
                    ...
                    <span className="text-gray-600 ml-3">{productReviews?.length} Reviews</span>
                </span>
                ...
                <p className="leading-relaxed">Stock Remaining: {product?.productStockQuantity}</p>
                ...
                {
                    product && product.productStockQuantity > 0 ? (<button onClick={handleCart}className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded" >Add to Cart</button>): (<p className="leading-relaxed" style={{"padding-left": "50px", "color" : "red"}}>Out of Stock</p>)
