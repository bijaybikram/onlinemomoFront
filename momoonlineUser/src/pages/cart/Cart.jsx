...
import { deleteCartItem, emptyCart, updateCartItem } from '../../store/cartSlice'
    ...
    <>
        ...
        {products.map((product)=> {
            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <p className="mt-1 text-xs text-gray-700">NPR {product?.product.productPrice}</p>
                </div>
                ...
                <div onClick={()=> handleCartItemDelete(product?.product?._id)} className="flex items-center space-x-4">
